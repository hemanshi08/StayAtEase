...
db.User.hasMany(db.Wishlist, { foreignKey: 'u_id' });
db.Property.hasMany(db.Wishlist, { foreignKey: 'p_id' });
db.Wishlist.belongsTo(db.User, { foreignKey: 'u_id' });
db.Wishlist.belongsTo(db.Property, { foreignKey: 'p_id' });
