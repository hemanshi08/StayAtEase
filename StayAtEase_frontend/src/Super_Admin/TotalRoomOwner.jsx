...
function TotalRoomOwner() {
  const users = [
    { id: 1, name: "John Smith", mobile: "9876543210", email: "john@example.com", status: "Active", img: "/profile_image/team-2.jpg" , TotalProperties : 5},
    { id: 2, name: "Emma Wilson", mobile: "9876543222", email: "emma@example.com", status: "Inactive", img: "/profile_image/team-3.jpg" , TotalProperties : 6},
    { id: 3, name: "Michael Brown", mobile: "9876543233", email: "michael@example.com", status: "Active", img: "/profile_image/team-4.jpg", TotalProperties : 2 },
    { id: 4, name: "Sarah Davis", mobile: "9876543244", email: "sarah@example.com", status: "Active", img: "/profile_image/testimonial-1.jpg" , TotalProperties : 3},
    { id: 5, name: "Robert Johnson", mobile: "9876543255", email: "robert@example.com", status: "Inactive", img: "/profile_image/testimonial-2.jpg", TotalProperties : 1 },
    { id: 6, name: "Sarah Davis", mobile: "9876543244", email: "sarah@example.com", status: "Active", img: "/profile_image/testimonial-1.jpg" , TotalProperties : 2},
    { id: 7, name: "Robert Johnson", mobile: "9876543255", email: "robert@example.com", status: "Inactive", img: "/profile_image/testimonial-2.jpg" , TotalProperties : 3},
  ...
  return (
    <div>
      ...
      <h2 className="text-3xl !font-bold">RoomOwners Details</h2>
          ...
          <table className="w-full border border-gray-300 text-gray-600">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="p-4 text-left">Total Properties</th>
            ...
            <tbody>
              {currentUsers.map((user) => (
                <tr key={user.id} className="border-b">
                  ...
                  <td className="p-4">{user.TotalProperties}</td>
