  ...
  return (
    <div>
      ...
      <div className="container mx-auto p-6 max-w-3xl">
        <h2 className="text-3xl font-bold text-center mb-6 text-left">Super Admin Profile Details</h2>
        ...
        {/* Profile Form */}
        <h2 className="text-xl font-bold">Super Admin Profile Details</h2>
